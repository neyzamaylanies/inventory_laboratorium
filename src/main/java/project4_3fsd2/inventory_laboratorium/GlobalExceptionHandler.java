...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EquipmentDamageException.class)
    @ResponseStatus(HttpStatus.FORBIDDEN) // 403 ✅ BEDA!
    public ErrorResponse handleEquipmentDamage(EquipmentDamageException ex) {
        return new ErrorResponse(
                "EQUIPMENT_DAMAGED",
                ex.getMessage(),
                "Equipment",
